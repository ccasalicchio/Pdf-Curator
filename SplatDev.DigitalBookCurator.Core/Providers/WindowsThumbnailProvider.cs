...
/// <summary>
/// Borowed from https://stackoverflow.com/a/21752100/791245
/// </summary>
namespace SplatDev.DigitalBookCurator.Core.Providers
{
    [Flags]
...
#pragma warning restore SYSLIB1054 // Use 'LibraryImportAttribute' instead of 'DllImportAttribute' to generate P/Invoke marshalling code at compile time
        ...
        {
            nint hBitmap = GetHBitmap(Path.GetFullPath(fileName), width, height, options);
        ...
        public static Bitmap GetBitmapFromHBitmap(nint nativeHBitmap)
        {
        ...
        private static nint GetHBitmap(string fileName, int width, int height, ThumbnailOptions options)
        {
            ...
            int retCode = SHCreateItemFromParsingName(fileName, nint.Zero, ref shellItem2Guid, out IShellItem nativeShellItem);
